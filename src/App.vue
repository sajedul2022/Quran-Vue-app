    ...
    <div class="container py-6">
      <div class="bg-white p-4 shadow-lg">
        ...
        <div v-else class="text-2xl">
          ...
          >
            <span
              class="text-xs inline-block w-8 h-8 flex items-center justify-center border rounded-full mr-4"
              >{{ ayah.numberInSurah }}
            </span>
            {{ ayah.text }}
          </p>
